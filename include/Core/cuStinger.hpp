...
public:
	...
	const length_t*   csrOff 			= NULL;
	const vertexId_t* csrAdj 			= NULL;
...
// __foreinline__
	...
	void initializeCuStinger(length_t nv_,length_t ne_,const length_t* off_, const vertexId_t* adj_);
...
private:
	...
	void internalCSRTocuStinger(const length_t* off, const vertexId_t* adj, length_t ne);
