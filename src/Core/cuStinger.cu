...
void cuStinger::internalCSRTocuStinger(const length_t* h_off, const vertexId_t* h_adj, length_t ne){
	...
	copyArrayHostToDevice((void*)h_off,d_off,nv+1,sizeof(length_t));
	copyArrayHostToDevice((void*)h_adj,d_adj,ne,sizeof(vertexId_t));
